...
create_dir languages/python/web/flask/{sql-injection-unparameterized-query,command-injection-shell-execution,nosql-injection-operator-injection,ssti-user-input-template-render,path-traversal-directory-escape,insecure-file-upload-unrestricted-upload,unsafe-deserialization-pickle-rce,unsafe-yaml-load-object-deserialization,reflected-xss-unescaped-html-response,stored-xss-persistent-html-injection,csrf-state-changing-post-without-token,broken-authentication-session-fixation-and-weak-session-id,jwt-validation-missing-alg-and-claim-verification,idor-horizontal-privilege-escalation-object-access,vertical-privilege-escalation-missing-backend-role-enforcement}
touch $(echo languages/python/web/flask/{sql-injection-unparameterized-query,command-injection-shell-execution,nosql-injection-operator-injection,ssti-user-input-template-render,path-traversal-directory-escape,insecure-file-upload-unrestricted-upload,unsafe-deserialization-pickle-rce,unsafe-yaml-load-object-deserialization,reflected-xss-unescaped-html-response,stored-xss-persistent-html-injection,csrf-state-changing-post-without-token,broken-authentication-session-fixation-and-weak-session-id,jwt-validation-missing-alg-and-claim-verification,idor-horizontal-privilege-escalation-object-access,vertical-privilege-escalation-missing-backend-role-enforcement}/{vuln_app.py,fixed_app.py,exploit_payload.txt,README.md})
